...
| [Apple Human Interface Guidelines](https://developer.apple.com/design/human-interface-guidelines/) | Clear hierarchy, simplicity, agency, consistency, recoverability, focused language, and careful detail | Public design guidance is **REFERENCE ONLY**. Soltex does not use Apple assets, fonts, materials, measurements, component geometry, copy, screenshots, code, or trade dress. Windows conventions remain authoritative for behavior. | Clean-room quality lens for calm spacing, typography, progressive disclosure, feedback, and reversible flows |
...
- Apply the Apple reference as principles, not appearance: one dominant task,
  calm spacing, strong typographic hierarchy, concise copy, immediate feedback,
  and safe recovery. Preserve native Windows controls and interaction grammar.
