...
public sealed record RemoteAssistExecutable
{
        ...
        out string error)
    {
        ...
        {
            error = "Soltex only launches an explicitly selected RustDesk.exe external client.";
            return false;
        }
        ...
        {
            error = "Soltex could not inspect the selected executable.";
            return false;
        }
        ...
        {
            error = "Soltex could not fingerprint the selected external client.";
            return false;
        }
    }
    ...
    public bool VerifyUnchanged(out string error)
    {
        ...
        {
            error = "Soltex could not revalidate the selected external client.";
            return false;
        }
    }
}
