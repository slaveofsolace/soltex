...
namespace WaveSlate.DeviceFabric;
        ...
        out string error)
    {
        ...
        foreach (string? capabilityId in capabilityIds)
        {
            ...
            if (platform != DevicePlatform.Windows &&
                capabilityId is global::WaveSlate.DeviceFabric.CapabilityIds.DefenderQuickScanRequest or
                    global::WaveSlate.DeviceFabric.CapabilityIds.DefenderIntelligenceUpdateRequest)
            {
