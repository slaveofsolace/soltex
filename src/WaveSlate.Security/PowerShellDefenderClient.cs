...
public sealed class PowerShellDefenderClient : IProtectionHealthSource
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            ["WAVESLATE_EVENT_START_UTC"] = DateTimeOffset.UtcNow.Subtract(lookback).ToString("O"),
            ["WAVESLATE_EVENT_MAX"] = maximumEvents.ToString(System.Globalization.CultureInfo.InvariantCulture)
        };
    ...
    private const string CustomScanCommand =
        ...
        "-ScanPath $env:WAVESLATE_SCAN_PATH -ErrorAction Stop";
