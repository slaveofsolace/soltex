        ...
        if (renderRequestParsed)
        {
                ...
                !window.TrySelectRenderSmokePanel(renderRequest.Panel))
            {
                throw new ArgumentException(
                    ...
                    "security, security-activity, remote, whisper, whisper-checks, whisper-personalize, whisper-library, whisper-library-styles, whisper-library-apps, whisper-scratchpad, whisper-history, whisper-privacy, whisper-privacy-warning, activity, update, mixer, mixer-devices, mixer-more, command-palette, clips.");
            }
